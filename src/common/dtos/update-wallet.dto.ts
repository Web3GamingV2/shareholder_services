 ...
 * @LastEditTime: 2025-04-22 14:07:22
...
export class UpdateWalletDto {
  // Validate that 'message' is a non-empty string initially.
  // More specific validation might involve checking its format if needed.
  @IsString({ message: 'SIWE 消息必须是字符串格式。' })
  @IsNotEmpty({ message: 'SIWE 消息不能为空。' })
  message: string; // The SIWE message string
